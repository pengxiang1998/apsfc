    ...
    <table border="0" cellspacing="0"  width="100%">
		...
		<tr>
		  <td  align="center" vlign="top"  >
			 <strong><span style="font-family: Helvetica, sans-serif;font-size: 20px;">${ requestScope.notice.name}
</span></strong>
			 <br>
			 <span style=" font-size: 10px;">${ requestScope.notice.times}
</span>
		  </td>
		</tr>
		<tr>
		  <td  align="left" vlign="top" >
             ...
             <span style=" font-size: 14px;"><br>&nbsp;&nbsp;&nbsp;&nbsp;  ${ requestScope.notice.content}</span><br><br>
		  </td>
		</tr>
		<tr>
		  <td  align="center"  >
