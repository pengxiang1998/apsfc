					...
					<div class="pdv_border"
						...
						<div style="padding: 0px">
							<div id="topmenu">
								...
								<a href="${pageContext.request.contextPath}/userLoginServlet?action=logout">注销退出</a>| 
								<a href="${pageContext.request.contextPath }/descriptionServlet?action=sendFindAll" target="_self">配送说明</a>| 
								<a href="${pageContext.request.contextPath }/descriptionServlet?action=findDesAll" target="_self">关于我们</a>
							</div>
							...
							<div id="menu">
								...
								<div id="mainmenu">
									<ul>
										...
										<li><a href="${empty user ? 'qiantai/login.jsp':'qiantai/shoppingcar.jsp'}" target="_self">我的餐车</a></li>

										<li><a href="${pageContext.request.contextPath}/ordersServlet?action=orderSearch1&&curPage=1&&username=${sessionScope.user.name}" target="_self">我的订单</a></li>
										<li><a href="${empty user ? 'qiantai/login.jsp':'qiantai/center.jsp'}" target="_self">用户中心</a></li>

										<li><a href="${pageContext.request.contextPath }/descriptionServlet?action=sendFindAll" target="_self">配送说明</a></li>

										<li><a href="${pageContext.request.contextPath }/descriptionServlet?action=findDesAll" target="_self">关于我们</a></li>

										<li><a href="${pageContext.request.contextPath}/userLoginServlet?action=logout">注销退出</a></li>
				...
				<div id='spdv_3608' class='pdv_top'
					...
					<div class="pdv_border"
						...
						<div
							...
							亲爱的${sessionScope.user.name}您好!&nbsp;&nbsp;欢迎光临!</div>
					</div>
				</div>
			</div>
