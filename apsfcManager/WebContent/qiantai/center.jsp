	...
	<table width="900" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td align="center" valign="center" height="450">
				...
				<form action="${pageContext.request.contextPath }/userLoginServlet?action=update" name="form1" method="post"
						...
						<table border="1" cellspacing="0" bordercolorlight="#C0C0C0"
							...
							<tr>
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
									height="25" align="right"><font color="#996633">用户名</font></td>
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
									height="25" align="left"><font color="red">${sessionScope.user.name}</font>
								</td>
								<td bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0"
